                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info text-center">
                                    ...
                                    <h2 class="post__title entry-title ">
                                        <a href="{{ route('post.single',['slug'=> $first_post->slug]) }}">{{$second_post->title}}</a>
                                    </h2>
                ...
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <h2 class="post__title entry-title text-center">
                                        <a href="{{ route('post.single',['slug'=> $first_post->slug]) }}">{{$third_post->title}}</a>
                                    </h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="case-item">
                                    ...
                                    <h6 class="case-item__title text-center"><a href="{{ route('post.single',['slug'=> $first_post->slug]) }}">{{ $post->title }}</a></h6>
                                </div>
                        </div>
